...
export async function runDocumentGenerationChain(
  ...
  const prompt = PromptTemplate.fromTemplate(
    [
      ...
      "careerDescription must be plain text with these headings (exactly in this order):",
      "- Introduce",
      "- Work Experience",
      "- Project",
      "- 보완 필요 항목 (optional, 0~2개 불릿 또는 1~2문장; 반드시 마지막에만 위치)",
      "Rules:",
      ...
      "- 보완 필요 항목: 입력에서 근거를 찾기 어려운 포인트만 0~2개로 간단히 제안하세요(수치/성과/근거 디테일 위주).",
